...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->string('user_name')->nullable(); // Now properly nullable
            $table->string('user_email')->nullable(); // Now properly nullable
            ...
            $table->string('payer_name_gateway')->nullable();
            $table->string('payer_email_gateway')->nullable();
