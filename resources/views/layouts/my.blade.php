            ...
            <nav class="bg-white shadow-lg">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-7">
                            ...
                            <div class="hidden md:flex items-center space-x-1">
                                ...
                                <a href="#" class="py-4 px-2 text-gray-500 font-semibold hover:text-blue-500 transition duration-300">Products</a>
                        ...
                        <div class="hidden md:flex items-center space-x-3 ">
                            ...
                            <a href="#" class="flex items-center py-2 px-2 text-gray-500 hover:text-blue-500 transition duration-300">
                ...
                <div class="hidden mobile-menu">
                    <ul class="">
                        ...
                        <li><a href="#" class="block text-sm px-2 py-4 hover:bg-blue-500 transition duration-300">Products</a></li>
                        ...
                        <li class="border-t border-gray-200"><a href="#" class="block text-sm px-2 py-4 hover:bg-blue-500 transition duration-300">Log In</a></li>
                        <li><a href="#" class="block text-sm px-2 py-4 hover:bg-blue-500 transition duration-300">Sign Up</a></li>
